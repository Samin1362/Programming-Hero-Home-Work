  ...
  return (
    <div className='flex flex-col justify-center items-center gap-2 md:mt-[30px]'>
      ...
      <div className="flex gap-4 p-4 items-center justify-center bg-base-300">
        <button className="bg-primary text-white text-[20px] py-[9px] px-[24px]">Latest</button>
        <p className="font-bold"><Marquee>Match Highlights: Germany vs Spain — as it happened   !   Match Highlights: Germany vs Spain as</Marquee></p>
      </div>
    </div>
  );
};
